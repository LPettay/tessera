...
| `0024-onframe-hook.md` | L4 `onFrame` interactivity hook — per-frame callback with cursor + per-entity offset writes; additive on top of declared `Animation`s (Accepted) |
