...
|---|---|---|
| `sunburst/` | [`sunburst/AGENTS.md`](./sunburst/AGENTS.md) | Quantized radial gradient + rotating ray overlay. v0.2.0 first concrete generator. |

### Planned (not yet created)

| Dir | Purpose | Tracked in |
|---|---|---|
| `halftone/` | Halftone-dot density gradient — second v0.2 generator, validates the abstraction across visually-distinct shapes | v0.2 milestone |
...
- **No shared state between generators.** A generator is a pure function — it has no mutable state, no init step, no module-level effects.
